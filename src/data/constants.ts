...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      "We charge minimal fees: 1% on payouts ≤$1,000 (or flat $10 for larger payouts), $0.50 to make ROSCAs public, 1% late payment fee, $0.20 for external transfers to wallets/exchanges, and small penalties for early goal withdrawals (1.0% at 0-24% progress down to 0.1% at completion).",
  },
  {
